...
For example:
DECLARE @TargetDatabase sysname = N'Admin_Test_Restore';
...
DECLARE @DataFile nvarchar(4000) = N'E:\LocalLabs2026\SQLDefault\SQLData\AdminDB_Test_Restore_DATA.mdf';

DECLARE @LogFile nvarchar(4000) =  N'E:\LocalLabs2026\SQLDefault\SQLLog\AdminDB_Test_Restore_LOG.ldf';

Confirm those folders exist and SQL Server can write to them.

6. Set the backup file and backup-set position.

    DECLARE @BackupFile nvarchar(4000) = N'T:\DBAScripts_22Aug2026.bak';
